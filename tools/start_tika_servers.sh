...
# nohup python geo_enrich.py --dest http://polar.usc.edu/solr/geo --tika http://localhost:9980/tika --start 0 --rows 1000 --rounds 100 > logs/9980.log 2>&1 &
# nohup python geo_enrich.py --dest http://polar.usc.edu/solr/geo --tika http://localhost:9981/tika --start 100000 --rows 1000 --rounds 100 > logs/9981.log &
# nohup python geo_enrich.py --dest http://polar.usc.edu/solr/geo --tika http://localhost:9982/tika --start 200000 --rows 1000 --rounds 100 > logs/9982.log &
# nohup python geo_enrich.py --dest http://polar.usc.edu/solr/geo --tika http://localhost:9983/tika --start 300000 --rows 1000 --rounds 100 > logs/9983.log &
# nohup python geo_enrich.py --dest http://polar.usc.edu/solr/geo --tika http://localhost:9984/tika --start 400000 --rows 1000 --rounds 100 > logs/9984.log &
# nohup python geo_enrich.py --dest http://polar.usc.edu/solr/geo --tika http://localhost:9985/tika --start 500000 --rows 1000 --rounds 100 > logs/9985.log &
